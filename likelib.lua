local Library = {} 
 ...
 function Library:Create(name,subname,keybind) 
         ...
         Main.Name = "Main" 
         Main.Parent = xz 
         Main.BackgroundColor3 = Color3.fromRGB(120, 240, 255) 
         ...
         function Window:tab(tabname,showonstartup) 
                 ...
                 Tab.BackgroundColor3 = Color3.fromRGB(0, 225, 255) 
                 ...
                 Page.BackgroundColor3 = Color3.fromRGB(0, 225, 255) 
                 ...
                 function pageitems:label(text) 
                         ...
                         Label.BackgroundColor3 = Color3.fromRGB(0, 225, 255) 
                 ...
                 function pageitems:button(text,callback) 
                         ...
                         Button.BackgroundColor3 = Color3.fromRGB(0, 225, 255) 
                 ...
                 function pageitems:toggle(text,state,callback) 
                         ...
                         Toggle_2.BackgroundColor3 = Color3.fromRGB(0, 225, 255) 
                 ...
                 function pageitems:input(text,placeholder,clearonreturn,callback) 
                         ...
                         Input.BackgroundColor3 = Color3.fromRGB(0, 225, 255) 
                         ...
                         Input_2.BackgroundColor3 = Color3.fromRGB(0, 225, 255) 
